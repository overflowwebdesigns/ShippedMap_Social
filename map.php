        ...
        click: function(event, data) {
            ...
            var slides = "";
                ...
                success:function (output) {
                    for (i = 0; i <br output['images'].length; i++) {
                        slides += '<div class="title" data-swiper-parallax="-100">' + output['names'][i] + '</div><br></br><br></br><div class="swiper-slide"><img src=' + output['images'][i] + '></div><br>';
                        name = output['names'][i];
                    }
